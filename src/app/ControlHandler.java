...
public class ControlHandler {
	private Frame frame;
	private JLabel modeText, speedT, speedC, openT, closedT, pathT, openC, closedC, pathC, noPathT;
	...
	public ControlHandler(Frame frame) {
		...
		dimensions = noPathT.getPreferredSize();
	...
	public void noPathTBounds() {
		noPathT.setBounds((int) ((frame.getWidth() / 2) - (dimensions.getWidth() / 2)), (int) ((frame.getHeight() / 2) - 70),
	...
	// Adds all components to frame so it can be packed 
	public void addAll() {
